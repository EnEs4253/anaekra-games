...
import PuzzleApp from '../games/puzzle/src/App';
import '../games/puzzle/src/index.css';
import { ArrowLeft } from 'lucide-react';

interface PuzzleGamePageProps {
  onNavigate?: (page: string) => void;
}

const PuzzleGamePage: React.FC<PuzzleGamePageProps> = ({ onNavigate }) => (
  <div className="w-full min-h-screen bg-blue-50 relative">
    {/* Sağ üst köşe geri butonu */}
    {onNavigate && (
