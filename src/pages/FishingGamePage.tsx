...
import FishingApp from '../games/fishing/src/App';
import '../games/fishing/src/index.css';
...
const FishingGamePage: React.FC<FishingGamePageProps> = ({ onNavigate }) => (
  <div className="w-full min-h-screen bg-blue-50 relative">
    {/* Sol üst köşe geri butonu - başlık kutusuna çakışmayacak şekilde */}
    {onNavigate && (
